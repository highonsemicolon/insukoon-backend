"""
Django settings for insukoon project.
...
WSGI_APPLICATION = 'insukoon.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # or any other authentication classes
    ],
...
EMAIL_HOST = os.environ.get('EMAIL_HOST', 'smtp.gmail')
