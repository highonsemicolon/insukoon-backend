...
class PaymentGatewayResponse(models.Model):
    ...
    vault = models.CharField(max_length=1, null=True, blank=True)
    ...
    retry = models.CharField(max_length=1, null=True, blank=True)
    response_code = models.CharField(max_length=20, null=True, blank=True)
    trans_date = models.DateTimeField(null=True, blank=True)
    bin_country = models.CharField(max_length=20, null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
